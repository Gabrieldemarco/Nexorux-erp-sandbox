    ...
    <div className="min-h-screen flex items-center justify-center bg-[#F8FAFC] px-4 py-10">
      <div className="max-w-md w-full space-y-8 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
        <div className="text-center">
          ...
          <h2 className="mt-6 text-2xl font-bold tracking-tight text-[#1E293B]">Crear cuenta</h2>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <input
              type="text"
              required
              className="appearance-none rounded-none relative block w-full px-3 py-2 border border-slate-300 placeholder-slate-400 text-brand-ink rounded-t-md focus:outline-none focus:ring-2 focus:ring-brand-light/40 focus:border-brand-mid focus:z-10 sm:text-sm"
            ...
            <input
              type="email"
              required
              className="appearance-none rounded-none relative block w-full px-3 py-2 border border-slate-300 placeholder-slate-400 text-brand-ink focus:outline-none focus:ring-2 focus:ring-brand-light/40 focus:border-brand-mid focus:z-10 sm:text-sm"
            ...
            <input
              ...
              required
              minLength={8}
              className="appearance-none rounded-none relative block w-full px-3 py-2 border border-slate-300 placeholder-slate-400 text-brand-ink rounded-b-md focus:outline-none focus:ring-2 focus:ring-brand-light/40 focus:border-brand-mid focus:z-10 sm:text-sm"
            ...
            {orgMode === 'join' && (
              <div className="space-y-3 rounded-md border border-gray-200 bg-white p-3">
                <div>
                  ...
                  <input
                    type="text"
                    className="block w-full rounded-md border border-slate-300 px-3 py-2 text-sm text-brand-ink focus:border-brand-mid focus:outline-none focus:ring-2 focus:ring-brand-light/40"
